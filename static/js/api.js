...
class LectureFlowAPI {
    ...
    async getRecordings() {
        const response = await fetch(`${API_BASE_URL}/teacher/recordings`, {
            credentials: 'include'
        });
        return response.json();
    }
    ...
    async getStudentRecordings() {
        const response = await fetch(`${API_BASE_URL}/student/recordings`, {
            credentials: 'include'
        });
        return response.json();
    }
    ...
    async getStudentTranscriptions() {
        const response = await fetch(`${API_BASE_URL}/student/transcriptions`, {
            credentials: 'include'
        });
        return response.json();
    }
